...
class User implements UserInterface
{
 ...
 const ROLE_SELLER= 'ROLE_SELLER';
    ...
    */
     ...
     * @Groups({"get", "get-product-list", "get-review"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"get", "post", "get-product-list", "get-review"})
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"get", "post", "put", "get-product-list", "get-review"})
     * @Assert\NotBlank(groups={"post"})
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"post", "put", "get-admin", "get-seller"})
     * @Assert\NotBlank(groups={"post"})
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Review", mappedBy="seller")
     * @Groups({"get"})
     */
    private $review;
