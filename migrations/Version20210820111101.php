 ...
 */
final class Version20210820111101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, seller_id INTEGER NOT NULL, product_id INTEGER NOT NULL, content CLOB NOT NULL, published DATETIME NOT NULL)');
